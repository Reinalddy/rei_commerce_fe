...
export default function AdminDashboard() {
    return (
        <div className="flex min-h-screen bg-gray-50 text-gray-800">
            {/* 🌿 SIDEBAR */}
            <aside className="w-64 bg-[#2E4E1E] text-white flex flex-col">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    <a
                        href="#"
                        className="block px-4 py-2 rounded-lg bg-green-700 hover:bg-green-600"
                    >
                        📊 Dashboard
                    </a>
                    <a href="#" className="block px-4 py-2 rounded-lg hover:bg-green-700">
                        🛍️ Products
                    </a>
                    <a href="#" className="block px-4 py-2 rounded-lg hover:bg-green-700">
                        💸 Sales Summary
                ...
                <div className="p-4 border-t border-green-800">
                    <button className="w-full bg-green-800 hover:bg-green-700 py-2 rounded-lg text-sm">
                        Logout
                    </button>
                </div>
            </aside>
